...
<div class="inquiry_wrapper">
					...
					<div class="content">
						<form id="frm" method="post" name="frm" onSubmit='return checkValid()' action="${pageContext.request.contextPath}/board/insert">
									...
									<tr>
										...
										<td>
											<span class="form_textarea" style="width:100%">
												<textarea cols="5" maxlength="300" name="content" rows="10" style="height:230px;"></textarea>
											</span>
										</td>
									</tr>
									<tr>
