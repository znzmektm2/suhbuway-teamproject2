...
.atch_file_area .ly_atch_file .clse {
    ...
    width: 16px;
    height: 15px;
    background: url(https://cafe.pstatic.net/cafe4/btn_layer_close3.gif) no-repeat 0 0;
}
...
.atch_file_area .ly_atch_file li .file_name {
    ...
    width: 160px;
    padding-left: 15px;
    background: url(https://cafe.pstatic.net/cafe4/w_ico_file.gif) no-repeat 0 2px;
    vertical-align: top;
    white-space: nowrap;
...
<body>
	...
	<a href="#" id ="atch_view m-tcol-c" class="atch_view m-tcol-c" onclick="oCLShow('attachLayer');return false;">첨부파일<span class="m-tcol-p">(<em>1</em>)</span></a>			
	  <div id="attachLayer" class="ly_atch_file" style="display: none; z-index: 1000; top: 15px; right: 0px; width: 240px;"> 
          <ul>					
			<li>
			<span class="file_name">${complain.fileName}</span>
			<div id="attahc" class="download_opt">
			<a href="${pageContext.request.contextPath}/board/down?fileName=${complain.fileName}">다운받기</a>
			</div>	
			</li>			
          </ul>
              <a href="#" onclick="oCLHide('attachLayer');return false;" class="clse"><span class="blind">닫기</span></a>
      </div>
	</div>
