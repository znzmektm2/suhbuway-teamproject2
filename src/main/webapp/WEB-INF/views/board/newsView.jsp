		...
		<div class="content">
			...
			<div class="news_view_conten">
				<div class="text_wrap">
					<p>
						<img
							src="${pageContext.request.contextPath}/resources/images/common/의사요한-3인_pick_써브웨이_20190725015947857.jpg"
							style="width: 789px;"><br>
					</p>
					<p>
						<br>
					</p>
					<p>
						써브웨이와 함께하는 SBS '의사요한'&nbsp; 많은 시청 부탁 드립니다.&nbsp;<br>
					</p>
				</div>
			</div>
