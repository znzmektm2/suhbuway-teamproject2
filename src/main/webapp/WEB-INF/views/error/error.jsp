...
<body>
	...
	<div id="content">
		<div class="innerWrap errorWrap">
			...
			<p class="txt">
				요청하신 페이지의 주소가 잘못 입력 되었거나,<br>변경 혹은 삭제가 되어 찾을 수 없습니다.<br>입력하신 주소가 정확한지 다시 한번 확인해 주시기
				바랍니다.
			</p>
			<div class="errorBtn">
				<a href="${pageContext.request.contextPath}"><span>메인으로 돌아가기</span></a> <a
					href="javascript:history.back()"><span>뒤로가기</span></a>
			</div>
			<p class="copy">SUBWAY® is a Registered Trademark of Subway IP Inc.© 2018 Subway IP Inc.All
				Rights Reserved.</p>
		</div>
	</div>
