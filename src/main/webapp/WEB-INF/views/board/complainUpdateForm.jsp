						...
						<tbody>
							<tr>
								...
								<td><span class="form_text" style="width: 100%"> <input maxlength="30"
										name="title" placeholder="제목을 입력해주세요" type="text" value="${complain.title}">
								</span></td>
							</tr>
							<tr>
								<th scope="col">내용<span class="ess"></span></th>
								<td><span class="form_textarea" style="width: 100%"> <textarea cols="5"
											maxlength="300" name="content" rows="10" style="height: 230px;">${complain.content}</textarea>
								</span></td>
							</tr>
							<tr>
								<th scope="col">첨부파일</th>
								<td><label class="form_file" style="width: 466px;"> <input maxlength="60"
										size="40" id="file" name="file" onchange="formFile(this); return false;" type="file">
